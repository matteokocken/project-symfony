 ...
 */
final class Version20220426084056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE im22_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, prix INTEGER NOT NULL, en_stock INTEGER NOT NULL)');
