 ...
 */
final class Version20220426161113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_secure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, login VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_538C4139AA08CB10 ON user_secure (login)');
        ...
        $this->addSql('CREATE TABLE im22_panier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, product_id INTEGER NOT NULL, quantity INTEGER NOT NULL, CONSTRAINT FK_E3BB1FCAA76ED395 FOREIGN KEY (user_id) REFERENCES user_secure (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E3BB1FCA4584665A FOREIGN KEY (product_id) REFERENCES im22_product (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_panier AS SELECT id, user_id, product_id, quantity FROM im22_panier');
        $this->addSql('DROP TABLE im22_panier');
        $this->addSql('CREATE TABLE im22_panier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, product_id INTEGER NOT NULL, quantity INTEGER NOT NULL, CONSTRAINT FK_E3BB1FCAA76ED395 FOREIGN KEY (user_id) REFERENCES user_secure (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO im22_panier (id, user_id, product_id, quantity) SELECT id, user_id, product_id, quantity FROM __temp__im22_panier');
        $this->addSql('DROP TABLE __temp__im22_panier');
        $this->addSql('CREATE INDEX IDX_E3BB1FCAA76ED395 ON im22_panier (user_id)');
        $this->addSql('CREATE INDEX IDX_E3BB1FCA4584665A ON im22_panier (product_id)');
